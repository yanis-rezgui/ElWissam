...
const ServicesSection = () => {
  ...
  {
    title: "Consultation et visites immobilières gratuites",
    description:
            ...
            {services.map((s,i)=>{
                return(
                    <div className="flex flex-col gap-7 items-center">
                        <h2 className="text-[#222344] font-bold text-[1.5em] text-center">
                            {s.title}
                        </h2>
                        ...
                        <div className="flex flex-row items-center justify-center gap-20 max-[700px]:flex-col max-[700px]:gap-10">
                            ...
                            alt={`Service de ${s.title.toLowerCase()} proposé par El Ahlem à Alger`}
                            />
                        </div>
                    </div>
                )
